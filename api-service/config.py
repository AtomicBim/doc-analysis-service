...
STAGE1_MAX_PAGES_PER_REQUEST = 30  # Максимум страниц метаданных в одном запросе (30 × 770 = 23,100 токенов < 30,000 TPM)
...
# ============================================================
# STAGE 2: Оценка релевантности страниц (high-res для gpt-4o-mini)
# ============================================================
...
STAGE3_MAX_TOKENS = 8000  # Максимальное количество токенов в ответе (увеличено для больших батчей)
...
# ============================================================
OPENAI_MODEL = "gpt-4o-mini"  # Модель для анализа (дешевле gpt-4o в ~15 раз)
