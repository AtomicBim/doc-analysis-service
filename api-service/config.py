...
STAGE2_MAX_PAGES_PER_REQUEST = 200  # Максимум страниц в одном запросе (200 × 85 = 17,000 токенов < 30,000 TPM, с запасом под текст)
...
# ============================================================
OPENAI_MODEL = "gpt-5-nano"  # Модель для анализа
